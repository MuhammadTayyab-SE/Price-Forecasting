...
df_train = spark.read.csv("../Dataset/train-test/train.csv", header=True, inferSchema=True)
...
df_test = spark.read.csv("../Dataset/train-test/test.csv", header=True, inferSchema=True)
